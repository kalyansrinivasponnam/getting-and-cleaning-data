...
Simply execute "run_analysis.R". Before that please download the data (details provided below) and extract the zip file inside the same folder as the script. 
